...
class CometBFTMempoolClient:
    ...
    def CheckTx(self, tx_bytes: bytes, cb: callable, tx_info: dict) -> None:
        ...
        logger.debug(f"Transaction message converted to hex {tx_hex}")
        logger.debug(f"Setting endpoints for broadcast {endpoint}")
        ...
        try:
            ...
            logger.debug(f"Message broadcaseted {response}")
